...
opt = {
    ...
    phase = 'testing',        -- training, val, testing  ,etc
    ...
    models_dir = './Trained-Models', -- loads models from here
...
print('models_dir', opt.models_dir)
local netG = util.load(paths.concat(opt.models_dir, opt.netG_name .. '.t7'), opt)
--netG:evaluate()
